...
public class OpenKitImpl implements OpenKit {
    ...
    protected OpenKitImpl(Logger logger, Configuration config, ConnectorProvider connectorProvider, TimingProvider timingProvider, ThreadIDProvider threadIDProvider) {
